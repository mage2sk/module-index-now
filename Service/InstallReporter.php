<?php
/**
 * Standalone install + heartbeat reporter for Panth_IndexNow.
 *
...
namespace Panth\IndexNow\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_IndexNow';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-index-now';
